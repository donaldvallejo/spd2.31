...
def test_cholesterol(total_cholostrol, ldl, triglyceride):
    ...
    tlc_diet = 200 <total_cholostrol < 240 or 130 < ldl < 160 or 150 <= triglyceride < 200
...
test_cholesterol(total_cholostrol, ldl, triglyceride)